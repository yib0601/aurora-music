    ...
    <div className="flex flex-col h-full overflow-hidden">
      <div className="glass-subtle p-6">
        ...
        <div className="flex items-end gap-6">
          <div className="w-48 h-48 rounded-xl bg-gradient-to-br from-purple-500/40 to-pink-500/40 flex items-center justify-center shadow-2xl flex-shrink-0">
            <ListMusic className="h-20 w-20 text-white/60" />
          </div>
          <div className="flex-1 pb-2">
            <p className="text-sm font-medium uppercase tracking-wider text-foreground/50 mb-1">
              播放列表
            </p>
      ...
      <div className="flex-1 overflow-y-auto scrollbar-thin">
        {playlistTracks.length === 0 ? (
          ...
          <div className="px-2 py-2">
            <div className="grid grid-cols-[40px_1fr_auto_auto] gap-3 px-4 py-2 text-xs text-foreground/40 uppercase tracking-wider border-b border-border/30">
              <span>#</span>
              <span>标题</span>
              <span>
                <Clock className="h-3.5 w-3.5" />
            ...
            {playlistTracks.map((track, idx) => (
              <div
                ...
                className={cn(
                  'grid grid-cols-[40px_1fr_auto_auto] gap-3 items-center px-4 py-2 rounded-lg cursor-pointer group transition-colors',
              ...
              >
                ...
                <span className="text-xs text-foreground/40 tabular-nums w-12 text-right">
                ...
                <div className="flex items-center gap-1 opacity-0 group-hover:opacity-100 transition-opacity w-16 justify-end">
                  <button
                    ...
                    className={cn(
                      'p-1.5 rounded hover:bg-foreground/10',
                  ...
                  <DropdownMenu>
                    <DropdownMenuTrigger asChild>
                      <button
                        ...
                        className="p-1.5 rounded hover:bg-foreground/10 text-foreground/40"
                      >
